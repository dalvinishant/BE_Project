...
fetch_grievance = (modal,link) => {
    ...
    else
    {
        let res = axios.get("http://127.0.0.1:5000/committeeAll"+link)
            ...
            console.log("list_grievance_:Data  = ",this.state.list_grievance.Data);
        }).catch(error=>{
           console.log(error.response)
        }) 
    }
...
componentDidMount(){
    this.get_c()
    //this.intervalID = setInterval(this.get_c.bind(this),6000);
}
...
put_chainid = (id) =>{
    ...
    const options = {
        ...
        data : {action:this.state.response},
                ...
                <div>
                    ...
                    <div className = "pl-4 pr-4 pb-4 pt-1" style = {{display:"flex",flexDirection:"row"}}>
                        ...
                        <div className = "shadow bg-white middlepane ml-3 p-2" id = "middlepane" style = {{width:"35%",borderRadius:"10px"}}>
                            ...
                            <div className="justify-content-around p-2" style = {{display:"flex",flexDirection:"row"}}>
                                <button className = "p-2 shadow bg-white" style= {{borderRadius:"10px",height:"130px",width:"31%",border:"white",outline:"none"}} onClick = {this.fetch_grievance.bind(this,"pending","_ip")}>
                                ...
                                <button className = "p-2 shadow bg-white" style= {{borderRadius:"10px",height:"130px",width:"31%",outline:"none",border:"white"}} onClick = {this.fetch_grievance.bind(this,"reverted","_")}>
                                ...
                                <button className = "p-2 shadow bg-white" style= {{borderRadius:"10px",height:"130px",width:"31%",outline:"none",border:"white"}} onClick = {this.forward_fetch_calls.bind(this)}>
                                    {/* <div class="circle shadow-sm"><b>+ 2</b></div> */}
                                    <center className="mt-2" style = {{width:"100%"}}>
                            ...
                            <div className="justify-content-around mt-4 pb-5 p-2" style = {{display:"flex",flexDirection:"row"}}>
                                <button className = "p-2 shadow bg-white" style= {{borderRadius:"10px",height:"130px",width:"31%",outline:"none",border:"white"}} onClick = {this.debared_fetch_calls.bind(this)}>
                                {/* <div class="circle shadow-sm"><b>+ 2</b></div> */}
                                    <center className="mt-2" style = {{width:"100%"}}>
                                ...
                                <button className = "p-2 shadow bg-white" style= {{borderRadius:"10px",height:"130px",width:"31%",outline:"none",border:"white"}} onClick = {this.fetch_grievance.bind(this,"resolved","_r")}>
                                    {/* <div class="circle shadow-sm"><b>+ 2</b></div> */}
                                    <center className="mt-2" style = {{width:"100%"}}>
                                ...
                                <button className = "p-2 shadow bg-white" style= {{borderRadius:"10px",height:"130px",width:"31%",outline:"none",border:"white"}} onClick = {this.fetch_grievance.bind(this,"all","")}>
                                    {/* <div class="circle shadow-sm"><b>+ 2</b></div> */}
                                    <center className="mt-2" style = {{width:"100%"}}>
                        ...
                        <div className = "shadow bg-white ml-3 p-2" style = {{width:"35%",borderRadius:"10px"}}>
                            ...
                            <div className = "justify-content-around mb-3" style = {{display:"flex",flexDirection:"row"}}>
                                ...
                                <center>
                                    <CircularProgressbar value={48} text="48%"/>
                                ...
                                <center>
                                    <CircularProgressbar id= "debared_circ" value={13} text="13%" />
                            ...
                            <hr/>
                            <ProgressBar>
                                <ProgressBar animated variant="success" label = {"38%"} now={38} key={1} />
                                <ProgressBar animated variant="warning" label = {"33%"} now={33} key={2} />
                                <ProgressBar animated striped variant="danger" label = {"10%"} now={10} key={3} />
                                <ProgressBar animated striped color = "#dadada" label = {"20%"} now={20} key={3} />
                            </ProgressBar>
                    ...
                    <Modal
                        ...
                        size='lg'>
                               ...
                               <div style= {{display : "flex",flexDirection:"row"}}>
                                    <Button id= "chat_button" className = "font_custom w-50" style = {{fontSize:"16px"}} variant="primary" onClick = {this.put_chainid.bind(this,1)}>•  &nbsp;Forward&nbsp;  •</Button>
                                    <Button className = "font_custom debared  w-50" style = {{fontSize:"16px"}} variant="primary" onClick = {this.put_chainid.bind(this,2)}>•  &nbsp;Debar&nbsp;  •</Button>
                               </div>
