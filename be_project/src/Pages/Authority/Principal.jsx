...
fetch_grievance = (modal,link) => {
    ...
    {
        let res = axios.get("http://127.0.0.1:5000/principal"+link)
            .then(res=>
            {
...
fetch_grievance_details = (item) =>{
    ...
    let res = axios.get("http://127.0.0.1:5000/principal/"+item.chainid)
    .then(res=>{
        this.setState({
                    ...
                    <Modal
                        ...
                        size='lg'>
                                        ...
                                        :
                                            ...
                                            <div style = {{borderLeft:"3px solid #434343"}}>
                                                <table className="p-1" style= {{width:"90%"}}>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <TextField id="trackFormLevel" name="trackFormLevel" label="Level" variant="outlined" value = "Principal" className="w-100" style={{marginBottom:"15px", height:"40px !important"}}/> 
                                                            </td>
                                                            <td>
                               ...
                               <div style= {{display : "flex",flexDirection:"row"}}>
                                    ...
                                    <Button className = {this.state.flag == 3 ? "font_custom returned w-100 disabled" : " returned font_custom w-100"} style = {{fontSize:"16px"}} variant="primary" onClick = {this.put_chainid.bind(this,2)}>•  &nbsp;Return&nbsp;  •</Button>
                               </div>
